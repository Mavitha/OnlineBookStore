...
-- 2. Create Books Table (Inventory Management)
CREATE TABLE books (
    id INT AUTO_INCREMENT PRIMARY KEY,
...
-- Insert Books
INSERT INTO books (title, author, category, price, cover_image) VALUES 
('The Pragmatic Programmer', 'David Thomas', 'Educational', 45.00, 'pragmatic.jpg'),
('Dune', 'Frank Herbert', 'Fiction', 20.50, 'dune.jpg'),
('Clean Code', 'Robert C. Martin', 'Educational', 50.00, 'cleancode.jpg');

-- Insert Dummy Orders with New Fields
INSERT INTO orders 
