...
<head>
  ...
  <title>Lumina Books — User Dashboard</title>
  ...
  <main class="app-main-content">
    ...
    <section class="app-view active">
      ...
      <div class="container" style="padding: 40px 0;">
        <h2>My Orders</h2>
        <div style="background: var(--bg-surface); padding: 20px; border-radius: 8px; border: 1px solid var(--border-color); margin-top: 20px;">
            <p><strong>Order #12345</strong> - $24.50 (Completed)</p>
        </div>
      </div>
    </section>
