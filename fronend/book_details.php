...
<head>
  ...
  <title>Lumina Books — Book Details</title>
  ...
  <main class="app-main-content">
    ...
    <section class="app-view active">
      ...
      <div class="container" style="padding: 40px 0; display: flex; gap: 40px;">
        <div style="flex: 1;"><img src="https://images.unsplash.com/photo-1544947950-fa07a98d237f?auto=format&fit=crop&w=600&q=80" style="width: 100%; border-radius: 8px;"></div>
        <div style="flex: 2;">
            <h2>The Architecture of Solitude</h2>
            <p>by Julian Vance</p>
            <p class="book-price" style="font-size: 24px;">$24.50</p>
            <p>An elegant meditation on silence, space, and the enduring architecture of human contemplation in the modern noisy age.</p>
